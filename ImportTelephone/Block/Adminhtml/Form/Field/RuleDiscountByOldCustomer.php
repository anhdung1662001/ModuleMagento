...
class RuleDiscountByOldCustomer extends AbstractFieldArray
{
    ...
    protected function _prepareToRender()
    {
        $this->addColumn('rule_discount', [
            'label' => __('Rule Discount For Old Customer'),
            'renderer' => $this->getRuleRenderer()
        ]);
        $this->addColumn('rate_new_customer', [
            'label' => __('Discount Rate For New Phone Number Group'),
